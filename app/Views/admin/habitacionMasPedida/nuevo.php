...
<?= $this->section('title') ?>Admin | Habitaciones más pedidas | Nuevo - <?= $this->endSection() ?>
      ...
      <!-- Cuerpo -->
        <div class="row">
            <div class="card">
                ...
                echo form_open(base_url().'AdminHabitacionMasPedida/nuevoHabitacion',$form); ?>
                ...
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary">Agregar top 3</button>
                    </div>
                </div>
