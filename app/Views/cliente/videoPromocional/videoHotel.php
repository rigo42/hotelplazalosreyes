<section class="section-cover" data-stellar-background-ratio="0.5" style="background-image: url(<?= base_url() ?>public/cliente/images/habitacion/juniorPrincipal.jpg);">
  <div class="container">
