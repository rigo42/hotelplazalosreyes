        ...
        <div class="post-content-body">
            ...
            <div class="row mb-5">
              <div class="col-md-12 mb-4 element-animate">
                <img src="<?php echo URL ?>libreria/images/anuncioSanblas1.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="col-md-6 mb-4 element-animate">
                <img src="<?php echo URL ?>libreria/images/anuncioSanblas2.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="col-md-6 mb-4 element-animate">
                <img src="<?php echo URL ?>libreria/images/anuncioSanblas3.jpg" alt="Image placeholder" class="img-fluid">
              </div>
            </div>
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-4 element-animate">
                <img src="<?php echo URL ?>libreria/images/anuncioSanblas4.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="col-md-6 mb-4 element-animate">
              ...
              <div class="col-md-6 mb-4 element-animate">
                <img src="<?php echo URL ?>libreria/images/anuncioSanblas5.jpg" alt="Image placeholder" class="img-fluid">
              </div>
            </div>
        </div>

        <!-- Video -->
        <?php  include('vista/videoPromocional/videoSanBlas.php')   ?>
        <!-- /video -->
