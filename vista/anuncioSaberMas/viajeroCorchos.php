<section class="site-section py-lg">
      ...
      <div class="container">
        ...
        <div class="row blog-entries">
          ...
          <div class="post-content-body">
              ...
              <div class="row mb-5">
                <div class="col-md-12 mb-4 element-animate">
                  <img src="<?php echo URL ?>libreria/images/anuncioCorchos1.jpg" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 mb-4 element-animate">
                  <img src="<?php echo URL ?>libreria/images/anuncioCorchos2.jpg" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 mb-4 element-animate">
                  <img src="<?php echo URL ?>libreria/images/anuncioCorchos4.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
              ...
              <div class="row mb-5">
                <div class="col-md-12 mb-4 element-animate">
                  <img src="<?php echo URL ?>libreria/images/anuncioCorchos6.jpg" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 mb-4 element-animate">
                  <img src="<?php echo URL ?>libreria/images/anuncioCorchos5.jpg" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 mb-4 element-animate">
                  <img src="<?php echo URL ?>libreria/images/anuncioCorchos7.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
          ...
          <?php include('vista/anuncioSaberMas/lugares.php') ?>
