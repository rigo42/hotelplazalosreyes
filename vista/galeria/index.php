<div align="center"><h1>Galeria</h1></div>
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item ">
      <img class="d-block w-100" src="<?php echo URL ?>libreria/images/recepcion1.png" alt="First slide" >
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color: #fff;">RECEPCIÓN</h5>
        <p style="color: #fff;">Te atenderemos con gusto.</p>
      </div>
    </div>
    <div class="carousel-item ">
      <img class="d-block w-100" src="<?php echo URL ?>libreria/images/recepcion-pasillo.jpg" alt="First slide" >
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color: #fff;">RECEPCIÓN</h5>
        <p style="color: #fff;">Te atenderemos con gusto.</p>
      </div>
    ...
    <div class="carousel-item ">
      <img class="d-block w-100" src="<?php echo URL ?>libreria/images/recepcion-pintura.jpg" alt="First slide" >
      <div class="carousel-caption d-none d-md-block">
        <h5 style="color: #fff;">RECEPCIÓN</h5>
        <p style="color: #fff;">Te atenderemos con gusto.</p>
      </div>
