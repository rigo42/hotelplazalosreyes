<section class="site-section">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-7">
        <img src="<?php echo URL ?>libreria/images/hotelFrente.jpg" alt="Image placeholder" class="img-md-fluid" width="100%" height="500px">
      </div>
     ...
     <div class="col-md-4">
        ...
        <div class="heading-wrap  element-animate">
          ...
          <p class=""> Ser una empresa ampliamente reconocida en el ramo hotelero con la más alta calidad en la satisfacción de las necesidades de nuestros clientes y llegar  a hacer  altamente competitivos dentro del mercado hotelero regional.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="heading-wrap  element-animate">
          ...
          <p class="">1.-  Proporcionar a los clientes comodidad y confort en su estancia.</p>

          <p>2.- Lograr ser el mejor Hotel de la región contando con el mejor espíritu de servicio.</p>
      ...
      <div class="col-md-6">
        <img src="<?php echo URL ?>libreria/images/logo.jpg" alt="Image placeholder" class="img-md-fluid" width="100%" height="500px">
      </div>
